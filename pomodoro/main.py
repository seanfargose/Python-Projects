...
canvas.create_image(110,115,image=tomoto_img)
timer_text = canvas.create_text(110,135,text="00:00",fill="white",font=(FONT_NAME,35,"bold"))
canvas.grid(row=1,column=1)



start_button = Button(text="Start",highlightthickness=0,bg=YELLOW, padx=1.5,pady=1.5,command=start_timer)
start_button.grid(column=0,row=2)

reset_button = Button(text="Reset" , highlightthickness=0,bg=YELLOW,padx=1.5,pady=1.5,command=reset_timer)
